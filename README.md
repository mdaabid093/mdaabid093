...
<h3 align="center">DevOps & Cloud Engineer | AWS | Azure | Kubernetes | CI/CD</h3>

---

### 🚀 About Me
- 🎓 B.E. Computer Science, East West Institute of Technology, Bangalore (2025)
- ☁️ AWS-focused Cloud & DevOps Engineer, with working knowledge of Azure
- 🔧 I build and automate cloud infrastructure, CI/CD pipelines, and Kubernetes deployments
- 🧪 Completed a 6-month AI DevOps internship (VTU / ROOMAN Technologies / IBM / NASSCOM / IIT Guwahati — WIINNR program)
- 📜 Certified: AI DevOps Engineering (NASSCOM–ROOMAN) · Elite Cloud Computing (NPTEL–IIT Madras)
- 📍 Based in Bangalore, originally from Siwan, Bihar
